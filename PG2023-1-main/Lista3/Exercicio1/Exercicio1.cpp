...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for(int i=1; i<4; i++) {
			...
			model = glm::rotate(model, (float)5/i*(float)glfwGetTime(), glm::vec3(0,0,1));
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		//x   y     z    r    g    b
		+1.f,        +0.f , 0.0, 1.0, 0.0, 0.0, //v0
		 -0.5f, float(+sqrt(3) / 2.f) , 0.0, 0.0, 1.0, 0.0, //v1
		 -0.5f, float(-sqrt(3) / 2.f) ,  0.0, 0.0, 0.0, 1.0  //v2
	};
