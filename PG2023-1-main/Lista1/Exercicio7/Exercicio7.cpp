...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Exercicio 7 - Sandro", nullptr, nullptr);
...
int setupGeometry()
{
	...
	float angle = 0.0;
	float deltaAngle = 6 * pi / (float)(nPoints);
	float radius = 0.0;
	float radiusIncrement = 0.5 / (float)(nPoints);
